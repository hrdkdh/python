...
def checkReady():
    ...
    print("                                                              ")
    print("===================================================================================================")
    print("명단 작성 및 입금정보 메일 자동발송 자동화 실행을 위해 준비사항을 체크합니다...")    
...
def downloadStudentImages():
    ...
    with requests.Session() as s:
        ...
        try:
            ...
            print("취창업캠프사이트 아이디/비번을 잘못 입력하였습니다. 코드를 재실행해 주세요.")
            sys.exit()
...
def makePPT():
    print("                                                              ")
    print("===================================================================================================")    
    go_on_sign1 = input("교육생 명단을 PPT로 작성하시겠습니까? 진행하려면 Y를, 패스하려면 N를 눌러주세요 : ")
    if go_on_sign1 == "Y" or go_on_sign1 == "y":
...
def sendEmail():
    print("                                                              ")
    print("===================================================================================================")
    go_on_sign = input("신분증/통장 사본 메일 발송을 하시겠습니까? 진행하려면 Y를, 패스하려면 N를 눌러주세요 : ")
    if go_on_sign == "Y" or go_on_sign == "y":
        print("신분증/통장 사본 발송을 위한 메일 작성을 시작합니다.")
        sendEmailExecute()
    else:
        print("메일 작성을 패스합니다.")

def sendEmailExecute():
